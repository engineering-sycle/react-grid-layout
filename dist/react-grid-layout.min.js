  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      (e.bottom = l),
        ...
        (e.cloneLayoutItem = c),
        (e.compareLayouts = function(t, e) {
          if (t.length !== e.length) return !1;
          for (var n = 0; n < t.length; n++) {
            var r = (0, o.default)(c(t[n]), c(e[n]));
            if (!r) return !1;
          }
          return !0;
        }),
      ...
      var c = (function(t) {
        ...
        return (
          ...
          (e.prototype.componentDidUpdate = function(t) {
            o.default.Children.count(t.children) !==
              o.default.Children.count(this.props.children) &&
              this.props.onLayoutChange(this.state.layout);
          }),
          (e.getDerivedStateFromProps = function(t, e) {
            return e.activeDrag
              ? { layout: e.layout }
              : (0, s.compareLayouts)(t.layout, e.layout)
              ? null
              : {
          ...
          (e.prototype.onDragStart = function(t, e, n, r) {
            ...
            if (u)
              return (
                this.setState({
                  oldDragItem: (0, s.cloneLayoutItem)(u),
                  oldLayout: this.state.layout
                }),
                this.props.onDragStart(i, u, u, null, o, a)
              );
          }),
          (e.prototype.onDrag = function(t, e, n, r) {
            ...
            if (c) {
              ...
              (u = (0, s.moveElement)(
                ...
                this.props.onDrag(u, i, c, f, o, a),
                this.setState({
                  layout: (0, s.compact)(u, this.compactType(), l),
                  activeDrag: f
                });
            }
          }),
          (e.prototype.onDragStop = function(t, e, n, r) {
            ...
            if (p) {
              (u = (0, s.moveElement)(
                ...
                this.props.onDragStop(u, i, p, null, o, a);
              var h = (0, s.compact)(u, this.compactType(), c),
          ...
          (e.prototype.onLayoutMaybeChanged = function(t, e) {
            e || (e = this.state.layout),
              (0, s.compareLayouts)(e, t) || this.props.onLayoutChange(t);
          }),
          (e.prototype.onResizeStart = function(t, e, n, r) {
            ...
            u &&
              ...
              this.props.onResizeStart(i, u, u, null, o, a));
          }),
          (e.prototype.onResize = function(t, e, n, o) {
            var a = o.e,
              ...
              d = (0, s.getLayoutItem)(l, t);
            if (d) {
              var y = void 0;
              if (h) {
                var g = (0, s.getAllCollisions)(
                  l,
                  r({}, d, { w: e, h: n })
                ).filter(function(t) {
                  return t.i !== d.i;
              ...
              this.props.onResize(l, c, d, b, a, i),
                this.setState({
                  layout: (0, s.compact)(l, this.compactType(), p),
                  activeDrag: b
                });
            }
          }),
          (e.prototype.onResizeStop = function(t, e, n, r) {
            ...
            var p = (0, s.compact)(u, this.compactType(), c),
          ...
          (e.prototype.processGridItem = function(t) {
            if (t && t.key) {
              var e = (0, s.getLayoutItem)(this.state.layout, String(t.key));
              if (!e) return null;
              var n = this.props,
                r = n.width,
                a = n.cols,
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (k["[object Float32Array]"] = k["[object Float64Array]"] = k[
          ...
          (k[u] = k[l] = k[j] = k[f] = k[z] = k[p] = k[h] = k[d] = k[g] = k[
            m
                ...
                (o.handleDragStart = function(e) {
                  ...
                  if (
                    ...
                    if (null != i) {
                      ...
                      !1 !== c &&
                        (o.props.enableUserSelectHack && U(r),
                  ...
                  if (o.state.dragging) {
                    ...
                    if (null != n) {
                      var r = n.x,
                        ...
                        i = Q(o, r, a),
                        s = t.findDOMNode(o);
                      s && o.props.enableUserSelectHack && G(s.ownerDocument),
                  ...
                  value: function() {
                    ...
                    if (e) {
                      ...
                      B(n, et.mouse.move, this.handleDrag),
                        ...
                        this.props.enableUserSelectHack && G(n);
                    }
                  }
                },
                {
              ...
              (e.onDrag = function(t, n) {
                ...
                if (e.props.bounds) {
                  ...
                  var s = (function(t, e, n) {
                      ...
                      return (
                        O(r.right) && (e = Math.min(e, r.right)),
                        O(r.bottom) && (n = Math.min(n, r.bottom)),
                        O(r.left) && (e = Math.max(e, r.left)),
                        O(r.top) && (n = Math.max(n, r.top)),
                        [e, n]
                      );
                    })(e, o.x, o.y),
                    u = N(s, 2),
            ...
            E(r, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  var f = this.props,
                    p = f.defaultClassName,
                    h = f.defaultClassNameDragging,
                    d = f.defaultClassNameDragged,
